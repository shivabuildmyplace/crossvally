...
function Footer() {
  ...
  console.log(path);
  return (
    <div className={`${path ? "hideFooter" : "footer"}`}>
      <div className="footer-content footer-align">
        <div className="footer-text">
          <ul>
            <li className="heading">Cross Valley Homes</li>
            <li>Captivate and Inspire.</li>
          </ul>

          <ul>
            <li className="email">Info@crossvalleyhomes.com</li>
            <li className="contactus">
              <div className="tags-section">
                <a
                  href="https://www.instagram.com/crossvalleyhomes?igsh=NnVhbzJzOXVkcXp2"
